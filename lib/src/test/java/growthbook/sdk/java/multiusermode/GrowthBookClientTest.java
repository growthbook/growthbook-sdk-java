...
class GrowthBookClientTest {
    ...
    void refreshGlobalContext_repositoryUpdated_updatesGlobalContextFeatures() {
        ...
        when(mockRepository.getParsedFeatures()).thenReturn(new AtomicReference<>(newFeatures));
    ...
    void getFeatureValue_floatFeature_returnsCorrectValue() {
        ...
        when(mockRepository.getParsedFeatures()).thenReturn(new AtomicReference<>(parsedFeatures));
    ...
    private GBFeaturesRepository createMockRepository() {
        ...
        when(repository.getParsedSavedGroups()).thenReturn(new AtomicReference<>(new com.google.gson.JsonObject()));
        return repository;
    }
